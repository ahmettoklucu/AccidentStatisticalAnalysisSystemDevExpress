...
var mUtil = function () {
    ...
    return {
        ...
        data: function (t) {
            ...
            {
                set: function (e, a) {
                    void 0 === t.customDataTag && (mUtilElementDataStoreID++,
...
var mLayout = function () {
    ...
    return {
        ...
        initMainPortlet: function () {
            mUtil.get("main_portlet") && ((i = r()).initSticky(),
                mUtil.addResizeHandler(function () {
                    i.updateSticky()
                }))
        },
        ...
        initHeader: function () {
            ...
            a = mUtil.get("m_header"),
                ...
                "hide" == mUtil.attr(a, "m-minimize-mobile") ? (o.minimize.mobile = {},
                    o.minimize.mobile.on = "m-header--hide",
                    o.minimize.mobile.off = "m-header--show") : o.minimize.mobile = !1,
                "hide" == mUtil.attr(a, "m-minimize") ? (o.minimize.desktop = {},
                    o.minimize.desktop.on = "m-header--hide",
                    o.minimize.desktop.off = "m-header--show") : o.minimize.desktop = !1,
                (e = mUtil.attr(a, "m-minimize-offset")) && (o.offset.desktop = e),
                (e = mUtil.attr(a, "m-minimize-mobile-offset")) && (o.offset.mobile = e),
        ...
        initAside: function () {
            ...
            s = mUtil.get("body"),
                ...
                c = mUtil.hasClass(d, "m-aside-left--offcanvas-default") ? "m-aside-left--offcanvas-default" : "m-aside-left",
                ...
                mUtil.hasClass(s, "m-aside-left--fixed") && (mUtil.addEvent(d, "mouseenter", function () {
                    r && (clearTimeout(r),
                        ...
                        n = setTimeout(function () {
                            mUtil.hasClass(s, "m-aside-left--minimize") && mUtil.isInResponsiveRange("desktop") && (mUtil.removeClass(s, "m-aside-left--minimize"),
                    ...
                    mUtil.addEvent(d, "mouseleave", function () {
                        n && (clearTimeout(n),
                            ...
                            r = setTimeout(function () {
                                mUtil.hasClass(s, "m-aside-left--minimize-hover") && mUtil.isInResponsiveRange("desktop") && (mUtil.removeClass(s, "m-aside-left--minimize-hover"),
                ...
                p = "1" === mUtil.attr(u, "m-menu-dropdown") ? "dropdown" : "accordion",
                "1" === mUtil.attr(u, "m-menu-scrollable") && (m = {
                    height: function () {
                ...
                0 !== $("#m_aside_left_minimize_toggle").length && ((o = new mToggle("m_aside_left_minimize_toggle", {
                    ...
                    mUtil.get("main_portlet") && i.updateSticky(),
                        t.pauseDropdownHover(800),
                        e.pauseDropdownHover(800),
